...
Despite the net positive effect on job creation, Basker and Noel (2009) highlight the downward pressure on local inflation as local businesses and competitors are forced to lower their prices by 1 to 1.2\%. Furthermore, Dube et al. (2007) find that a new Walmart store reduces local retail revenue levels by 0.5 o 0.9\% at the county level.
...
from polygons and points

count of a given amenity within a given MSOA

the pure count is considered to be 

first to use this method

within-class homogeneity is assumed

decreasing returns to scale and spillover effects discussed in \ref{subsection:limitations}
