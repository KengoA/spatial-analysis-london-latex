...
\subsection{Monocentricity Assumption and Current Research on Housing Prices} \label{subsection:review}
...
ln(P) = b + \tau_2 ln(uber\_dist) + \epsilon
\end{gather}
...
I follow Clogg et al. (1995) to examine the difference between the two coefficients $\tau_1$ and $\tau_2$ in two different models, and calculate that $Z = \frac{\tau_1 - \tau_2}{\sqrt{(SE\tau_1)^2 + (SE\tau_2)^2}}  = \frac{-0.583 - (-0.649)}{\sqrt{0.021)^2 + (0.025)^2}} = 2.021$. $P(Z > 2.021) = 0.022$, which is statistically significant at the 5\% level. 
