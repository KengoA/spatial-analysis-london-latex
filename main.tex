...
\hline \\[-1.8ex] 
 ...
 commercial &  &  & 0.009$^{***}$ & $-$0.006$^{*}$ & $-$0.004 & $-$0.005 \\ 
  ...
  & & & & & & \\ 
%  garden &  &  & 0.001 & 0.0005 & 0.0004 & 0.001 \\ 
%   &  &  & (0.0005) & (0.0004) & (0.0004) & (0.0004) \\ 
%   & & & & & & \\ 
%  pitch &  &  & 0.010$^{***}$ & 0.009$^{***}$ & 0.008$^{***}$ & 0.007$^{***}$ \\ 
%   &  &  & (0.001) & (0.001) & (0.001) & (0.001) \\ 
%   & & & & & & \\ 
%  park &  &  & $-$0.004$^{***}$ & $-$0.004$^{***}$ & $-$0.005$^{***}$ & $-$0.004$^{***}$ \\ 
%   &  &  & (0.001) & (0.001) & (0.001) & (0.001) \\ 
%   & & & & & & \\ 
%  playground &  &  & $-$0.018$^{***}$ & $-$0.017$^{***}$ & $-$0.020$^{***}$ & $-$0.010$^{***}$ \\ 
%   &  &  & (0.004) & (0.004) & (0.004) & (0.004) \\ 
%   & & & & & & \\ 
%  nature\_reserve &  &  & 0.006 & 0.014 & 0.009 & 0.032$^{**}$ \\ 
%   &  &  & (0.016) & (0.016) & (0.016) & (0.015) \\ 
%   & & & & & & \\ 
 golf\_course &  &  & 0.224$^{***}$ & 0.211$^{***}$ & 0.202$^{***}$ & 0.168$^{***}$ \\ 
  &  &  & (0.020) & (0.020) & (0.020) & (0.019) \\ 
  & & & & & & \\ 
%  hotel &  &  &  & $-$0.004$^{*}$ & $-$0.003 & $-$0.003 \\ 
%   &  &  &  & (0.002) & (0.002) & (0.002) \\ 
%   & & & & & & \\ 
%  attraction &  &  &  & 0.020$^{***}$ & 0.019$^{***}$ & 0.021$^{***}$ \\ 
%   &  &  &  & (0.006) & (0.006) & (0.006) \\ 
%   & & & & & & \\ 
%  museum &  &  &  & 0.031$^{**}$ & 0.031$^{**}$ & 0.018 \\ 
%   &  &  &  & (0.015) & (0.015) & (0.014) \\ 
%   & & & & & & \\ 
%  art &  &  &  & 0.024 & 0.028$^{*}$ & $-$0.009 \\ 
%   &  &  &  & (0.016) & (0.016) & (0.016) \\ 
%   & & & & & & \\ 
